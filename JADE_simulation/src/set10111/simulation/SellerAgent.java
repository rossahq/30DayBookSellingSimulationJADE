...
public class SellerAgent extends Agent {
		...
		public void action() {
			...
			if(msg != null) {
				...
				if(msg.getContent().equals("new day")) {
					...
					myAgent.addBehaviour(new PurchaseServer(myAgent));
	...
	public class PurchaseServer extends OneShotBehaviour {

		public PurchaseServer(Agent a) {
			super(a);
		}
		...
		public void action() {
			...
			if(msg != null) {
				...
				reply.setContent(String.valueOf(booksForSale.get(book)));
				myAgent.send(reply);
				System.out.println("Sold: " + book + " for £" + booksForSale.get(book));
			 }
			else {
				block();
			}
